 ...
 */
public class StaffTeamAdapter extends BaseAdapter {
    private List<Achievement> list;

    public StaffTeamAdapter(List<Achievement> list) {
        this.list = list;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_staffteam, null);
        ...
        if (position % 2 == 0) {
            ...
            holder.allsales.setBackgroundColor(color);
        ...
        holder.allsales.setText(achievement.getSalesman());
        return convertView;
    }


    public class StaffTeamHolder {
        @ViewInject(R.id.listview_fragmentstaffteam_team)
        public TextView name;
        @ViewInject(R.id.listview_fragmentstaffteam_customer)
        public TextView allcustomer;
        @ViewInject(R.id.listview_fragmentstaffteam_sales)
        public TextView allsales;
    }
}
