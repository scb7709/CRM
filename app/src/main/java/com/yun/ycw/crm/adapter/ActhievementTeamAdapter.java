 ...
 */
public class ActhievementTeamAdapter extends BaseAdapter {
    private List<Achievement> list, list2;
    private BarData data;
    private BarDataSet dataSet;
    private Context context;

    public ActhievementTeamAdapter(List<Achievement> list, List<Achievement> list2, Context context) {
        this.list = list;
        this.list2 = list2;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_achievementteam, null);
    ...
    public class ActhievementTeamHolder {
        @ViewInject(R.id.listview_achievimentteam_username)
        public TextView username;
        @ViewInject(R.id.listview_achievimentteam_allmoney)
        public TextView allmoney;
        @ViewInject(R.id.listview_achievimentteam_allorder)
        public TextView allorder;
        @ViewInject(R.id.listview_achievimentteam_allcommission)
        public TextView allcommission;
        @ViewInject(R.id.listview_achievimentteam_allcustomer)
        public TextView allcustomer;
        @ViewInject(R.id.listview_achievimentteam_scheduleBarChart)
