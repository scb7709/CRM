...
public class DatePickDialog implements DatePicker.OnDateChangedListener,
    ...
    public AlertDialog dateTimePicKDialog(final TextView inputDate) {
        LinearLayout dateTimeLayout = (LinearLayout) activity.getLayoutInflater().inflate(R.layout.dialog_datepick, null);
        datePicker = (DatePicker) dateTimeLayout.findViewById(R.id.datepick);
        init(datePicker);
        ad = new AlertDialog.Builder(activity)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        String newTime = time.substring(0, 4) + "-" + time.substring(5, 7) + "-" + time.substring(8, 10);
                        inputDate.setText(newTime);
