...
public class DateTimePickDialog implements DatePicker.OnDateChangedListener,
    ...
    public AlertDialog dateTimePicKDialog(final TextView inputDate) {
        LinearLayout dateTimeLayout = (LinearLayout) activity
                .getLayoutInflater().inflate(R.layout.dialog_datetimepick, null);
        ...
        ad = new AlertDialog.Builder(activity)
                ...
                .setPositiveButton("设置", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        String newTime = time.substring(0, 4) + "-" + time.substring(5, 7) + "-" + time.substring(8, 10) + " " + time.substring(12, 17);
